...
var ayush=User(name: "Ayush", age: 20, height: 167, weight: 65.00)
print(ayush)
...
struct Distance{
    ...
    init(meter: Double) {
        self.meter = meter
        self.feet = self.meter*3.28084
    }
    init(feet:Double){
        self.feet=feet
        self.meter=self.feet/3.28084
    }
}

var distance=Distance(meter: 1600.00)
print(distance)
...
var another=Distance(feet:5249.344)
print(another)
